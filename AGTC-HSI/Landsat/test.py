...
def create_images(ckpt_path, N_iter, input_dim, test_data_path='Landsat_test.mat', ground_truth_path=None):
    ...
    # Save result
    output_path = './Metrics/Landsat-AGTC.npy'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', default='./Weight/AGTC-Landsat.pth', help='Path to checkpoint')
    ...
    parser.add_argument('--test_data', default='Landsat_test.mat', help='Test data path')
